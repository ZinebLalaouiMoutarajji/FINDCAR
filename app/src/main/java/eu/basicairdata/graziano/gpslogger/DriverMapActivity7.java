...
public class DriverMapActivity7 extends FragmentActivity implements OnMapReadyCallback, RoutingListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    try{
                        ...
                        KmlLayer kmlLayer = new KmlLayer(mMap,R.raw.campus23, getApplicationContext());
                        kmlLayer.addLayerToMap();
                        KmlLayer kmlLayer1 = new KmlLayer(mMap,R.raw.campus24, getApplicationContext());
                        kmlLayer1.addLayerToMap();
                        KmlLayer kmlLayer2 = new KmlLayer(mMap,R.raw.campus25, getApplicationContext());
                        kmlLayer2.addLayerToMap();
                        KmlLayer kmlLayer3 = new KmlLayer(mMap,R.raw.campus26, getApplicationContext());
                        kmlLayer3.addLayerToMap();
                        KmlLayer kmlLayer4 = new KmlLayer(mMap,R.raw.campus27, getApplicationContext());
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriverMapActivity7.this, MainActivity.class);
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivity7.this, DriverSettingsActivity.class);
                startActivity(intent);
                return;
            }
        });
        mHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DriverMapActivity7.this, GPSActivity.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(DriverMapActivity7.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
                            }
                        })
                        .create()
                        .show();
